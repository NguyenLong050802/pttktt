...
import 'package:pttktt/question/question10/ctl/qt10ctl.dart';

Widget question10(BuildContext context) {
        ...
        children: [
          SizedBox(
            child: Column(
              children: [
                Text(
                  'Question 10 : Cho dãy số nguyên A có n phần tử cần được sắp xếp thành dãy số không giảm theo phương pháp sắp sếp trộn MergeSort. Hãy thiết kế thuật toán sắp xếp theo phương pháp chia để trị.',
            ...
            child: MyTextButton(
              ...
              onPressed: () {
                if (formKey.currentState!.validate()) {
                  ...
                  mergeSort10(list, 0, list.length - 1);
